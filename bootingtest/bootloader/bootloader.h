...
#define BL_DEBUG_INFO		BL_DEBUG_INFO_ENABLE
...
#define CBL_SEND_ACK															0xAF
#define CBL_SEND_NACK															0xAB

/******* start address of sector 2 ****/
#define FLASH_SECTOR2_BASE_ADDRESS								0x08010000
...
#define WRP_STATE_EN															OB_WRPSTATE_ENABLE		// 0x01
#define WRP_STATE_DIS															OB_WRPSTATE_DISABLE  // 0x00
